// N-API 绑定层：把 sdk/cpp 的 audiotse::SpeakerGate 暴露为 Node/Electron 可直接
// require 的 .node addon（NAPI_VERSION=8，ABI 稳定，Node 18+ / Electron 41 免重编译）。
//
// 模块导出：createGate(config) -> Promise<Gate>
